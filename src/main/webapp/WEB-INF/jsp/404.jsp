...
<link href="<%=request.getContextPath() %>/assets/css/pages/error.css" rel="stylesheet" type="text/css" />
    ...
    <div class="row">
        <div class="col-md-12 page-404">
            ...
            <div class="details">
                ...
                <p>
                    We can not find the page you're looking for.<br /> <a href="<%=basePath%>">Return home</a>
                </p>
            </div>
        </div>
    </div>
...
<![endif]-->
    ...
    <script src="<%=request.getContextPath() %>/assets/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
    ...
    <!-- END CORE PLUGINS -->
    <script src="<%=request.getContextPath() %>/assets/scripts/app.js"></script>
    <script>
