...
<body>
<form action="<%=request.getContextPath() %>/project/updateProject" class="form-horizontal" role="form"  method="post" onsubmit="return check()" style="width: 98%">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="projectMantis" id="projectMantis" value="${project.projectMantis}"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="categoryMantis">mantis项目分类</label>
        <div class="col-sm-3">
            <input type="text" class="form-control" name="categoryMantis" id="categoryMantis" value="${project.categoryMantis}"/>
        </div>
        <label class="col-sm-2 control-label" for="versionMantis">mantis版本号</label>
        <div class="col-sm-3">
            <input type="text" class="form-control" name="versionMantis" id="versionMantis" value="${project.versionMantis}"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <select name="productId" id="productId" class="form-control">
                <c:forEach var="productMap" items="${productMap}">
                    <option value="${productMap.key}" <c:if test="${project.productId==productMap.key}">selected</c:if>>${productMap.value}</option>
                </c:forEach>
            </select>
        </div>
   ...
   <div class="form-group">
        ...
        <div class="col-sm-3">
            <select name="projectStatus" id="projectStatus" class="form-control">
                ...
                <c:forEach var="projectStatus" items="${projectStatus}">
                    <option value="${projectStatus.value}" <c:if test="${project.projectStatus==projectStatus.value}">selected</c:if>>${projectStatus.text}</option>
                </c:forEach>
            </select>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="requirementDays" id="requirementDays" value="${project.requirementDays}">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="acceptanceDays" id="acceptanceDays" value="${project.acceptanceDays}">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-sm-offset-4 col-sm-6">
            ...
            <button type="button" name="cancel" id="cancel" class="btn btn-default" onclick="javascript:history.go(-1);">取消</button>
        </div>
    </div>
</form>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/assets/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
...
<script type="text/javascript">
    function check() {
        ...
        if (document.getElementById('projectMantis').value == "") {
